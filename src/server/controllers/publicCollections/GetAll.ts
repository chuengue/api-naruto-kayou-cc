...
export const getAllPublicCollection = async (req: Request<{}, {}, {}, IPublicCollectionsProps>, res: Response) => {
    const filters = {
    ...
    const result = await PublicCollectionsProviders.getPublicCollections(filters);
